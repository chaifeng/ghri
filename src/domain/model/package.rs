...
use crate::domain::model::{LinkRule, Release, VersionedLink};
...
pub struct Meta {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub versioned_links: Vec<VersionedLink>,
...
impl MetaExt for Meta {
    ...
    fn apply_defaults<R: Runtime>(&mut self, runtime: &R, meta_path: &Path) {
        ...
        // Convert relative link destinations to absolute paths
        // Links are stored relative to the package directory (parent of meta.json)
